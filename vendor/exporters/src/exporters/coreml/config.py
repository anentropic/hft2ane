...
class CoreMLConfig:
    ...
    def sequenceLength(self) -> int:
        ...
        """
        return self.overrides.get("sequenceLength", self.max_sequence_length)

    @property
    def use_flexible_shapes(self) -> bool:
        """
        When True, inputs are allowed to use sequence lengths of `1` up to `max_sequence_length`.
    ...
    def input_ids_sequence_length(self) -> Union[Tuple, int]:
        ...
        return (
            ...
            if self.use_flexible_shapes
            else self.sequenceLength
        )
