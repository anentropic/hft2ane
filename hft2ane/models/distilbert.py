...
class DistilBertForSequenceClassification(
    ANEDistilBertMixin, modeling_distilbert.DistilBertForSequenceClassification
):
    def __init__(self, config):
        super().__init__(config)
        setattr(self, "distilbert", DistilBertModel(config))
...
class DistilBertForQuestionAnswering(
    ANEDistilBertMixin, modeling_distilbert.DistilBertForQuestionAnswering
):
    def __init__(self, config):
        super().__init__(config)
        setattr(self, "distilbert", DistilBertModel(config))
...
class DistilBertForTokenClassification(
    ANEDistilBertMixin, modeling_distilbert.DistilBertForTokenClassification
):
    def __init__(self, config):
        super().__init__(config)
        setattr(self, "distilbert", DistilBertModel(config))
...
class DistilBertForMultipleChoice(
    ANEDistilBertMixin, modeling_distilbert.DistilBertForMultipleChoice
):
    def __init__(self, config):
        super().__init__(config)
        setattr(self, "distilbert", DistilBertModel(config))
