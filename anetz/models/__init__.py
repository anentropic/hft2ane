...
model classes in the transformers package.

Modules should also define a MODEL_TYPE attribute that is the name of the
base model type, e.g. 'bert' or 'distilbert'.
"""
